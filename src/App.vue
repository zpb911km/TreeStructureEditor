...
<template>
  <div class="min-h-screen flex flex-col pb-20">
    ...
    <!-- 底部导航栏 -->
    <nav class="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 shadow-lg z-50">
      <div class="flex items-center justify-around max-w-md mx-auto h-full">
        ...
        >
          ...
          <span class="text-xs mt-1 text-gray-600 dark:text-slate-300">Editor</span>
        </router-link>
        ...
        >
          ...
          <span class="text-xs mt-1 text-gray-600 dark:text-slate-300">Files</span>
        </router-link>
        ...
        >
          ...
          <span class="text-xs mt-1 text-gray-600 dark:text-slate-300">Settings</span>
        </router-link>
      </div>
    </nav>
